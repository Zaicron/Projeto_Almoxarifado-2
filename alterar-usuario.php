...
<html>
    <head>
        <title>Almoxarifado - Alterar Cadastro de Usuario</title>
        <meta charset="utf-8">
            ...
            <div class="container">
                ...
                <form>
                    <div class="form-input">
                        <input type="text" name="name" placeholder="Insira a ID do usuario:">
                    </div>
                    <div class="form-input">
                        <input type="text" name="username" placeholder="Insira a senha atual:">
                    </div>
                    <div class="form-input">
                        <input type="password" name="password" placeholder="Insira a nova senha:">
                    </div>
                    <div class="form-input">
